...
const FAQ_DATA = [
  ...
  {
    keywords: ['զամբյուղ', 'ինչպես ուղղարկել ապրանք', 'inchpes @ntrel apranq', 'ավելացնել', 'որտեղ է զամբյուղը', 'vortex e zambyux@'],
  ...
  {
    keywords: ['պատվեր', 'patver katarel', 'հաստատել', 'գնել', 'ձևակերպել'],
  ...
  {
    keywords: ['կիսվել զանբյուղով', 'ուղղարկել ընտրած տեսականին', 'inchpes uxrakel tesakanin', 'viber', 'whatsapp', 'telegram', 'kisvel zambyuxov'],
    answer: "կիսվել զամբյուղով՝\n• **Viber**\n• **WhatsApp**\n• **Telegram**\n\nԿոճակները հայտնվում են զամբյուղում՝ երբ այնտեղ կա առնվազն **1 ապրանք**։ Կամ օգտվեք **«ԱԴՄԻՆ»** բաժնից։"
  },
  {
